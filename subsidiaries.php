						...
						<div class="inner">
            	            ...
            	            <!-- Logo -->
								<a href="index.html" class="logo">
									<span class="symbol">
									    <img src="images/xyz_bg_rd.png" 
									    alt="sculpIT.xyz" />
									    </span>
									    <span class="title">sculpIT.xyz</span>
								</a>
...
<div style="margin-right:auto;
    ...
    <p style="font-family:giorgio;
              ...
              line-height:30px;
              margin-bottom:20px" >
        sculpIT Venture Capital our private equity arm
        <br/>
        focused on new technologies and solutions for health and fitness
    </p>
